          ...
          <article className="w-full rounded-2xl border border-primary/20 bg-card p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/35 hover:shadow-lg">
            ...
            <ul className="mt-4 space-y-3 text-sm leading-relaxed text-foreground/85">
              <li className="flex items-start gap-3">
                ...
                <span>
                  Build and optimize frontend experiences with React/Next.js for
                  responsive, user-friendly products.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1.5 size-2.5 shrink-0 rounded-full bg-primary/70" />
                <span>
                  Design and maintain backend APIs, business logic, and data
                  flows for scalable, reliable systems.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1.5 size-2.5 shrink-0 rounded-full bg-primary/70" />
                <span>
                  Integrate AI features into products, from model-driven
                  capabilities to intelligent workflow automation.
                </span>
              </li>
            </ul>
          </article>
